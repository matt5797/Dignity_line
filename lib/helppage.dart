...
List<Vehicle> vehicles = [
  ...
  new Vehicle(
    ...
    ['주택용(저압)은 주거용 고객으로 계약 전력 3kW 이하의 고객, 독신자 합숙소(기숙사 포함) 또는 집단 주거용 사회복지시설로서 고객이 주택용 전력의 적용을 희망하는 경우, 주거용 오피스텔 등의 경우 사용하는 형태의 전기 요금제입니다.',
      ...
      '저압, 고압 구분은 한전의 입장에서 공급하는 전기의 전압을 의미합니다.',
    ],
    Icons.error_outline,
  ),
  new Vehicle(
    ...
    ['사회적으로 보호를 필요로 하는 고객의 주거용 전력에 대해 요금을 할인하여 주는 제도입니다.',
      '5인 이상 가구, 출산 가구, 3자녀 이상 가구, 생명 유지 장치, 독립유공자, 국가유공자, 5.18민주유공자, 장애인, 사회복지시설, 기초생활(생계,의료), 기초생활(주거,교육), 차상위계층 등의 유형이 있고 복수 적용 받을 수 없습니다.'
    ],
    Icons.error_outline,
  ),
  new Vehicle(
    ...
    ['본 앱은 기상청에서 수집한 정보를 바탕으로 합니다. 기준지점은 이 자료를 수집한 장소를 선택하는 것입니다. 기준 지점에 따라 활용하는 자료와 결과는 달라집니다.',
    ],
    Icons.error_outline,
  ),
  new Vehicle(
    ...
    ['전기세 고지서를 확인하거나, 인터넷을 통해 간단히 확인 가능합니다. 앱을 통해 확인할 수도 있습니다.',
    ],
    Icons.error_outline,
  ),
  new Vehicle(
    ...
    ['에어컨 냉방효율은 기계의 열효율을 의미합니다.',
      '에어컨 정격냉방능력은 정격냉방능력을 내기 위해서 필요한 최소한의 전력을 의미합니다.'
    ],
    Icons.error_outline,
  ),
];